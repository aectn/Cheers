...
export const siteConfig: SiteConfig = {
	title: "奇思科创社",
	subtitle: "揭阳一中奇思科创社 · 用代码与创造点亮校园",
	siteURL: "https://cheers.aectn.top/", // 站点URL，以斜杠结尾
	...
	themeColor: {
		hue: 210, // 主题色：科技蓝（210）。红色：0，青色：200，蓝绿色：250，粉色：345
		fixed: false, // 对访问者隐藏主题色选择器
	},

	// 特色页面开关配置（关闭未使用的页面有助于提升 SEO，关闭后请记得在 navbarConfig 中移除对应链接）
	featurePages: {
		anime: false, // 番剧页面：社团站不需要
		diary: false, // 日记页面：关闭
		friends: false, // 友链页面：关闭（如需可后续开启）
		projects: false, // 项目页面：关闭
		skills: false, // 技能页面：关闭
		timeline: false, // 时间线页面：关闭
		albums: true, // 相册页面：保留，用于社团活动照片
		devices: false, // 设备页面：关闭
		aiTools: false, // AI 工具页面：关闭
	},
